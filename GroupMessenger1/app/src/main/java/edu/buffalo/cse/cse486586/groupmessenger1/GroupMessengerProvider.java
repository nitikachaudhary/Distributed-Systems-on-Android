...
public class GroupMessengerProvider extends ContentProvider {
    ...
    // references : https://www.tutorialspoint.com/android/android_shared_preferences.htm
    @Override
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        sharedPreferences = getContext().getSharedPreferences(MESSAGES,Context.MODE_PRIVATE);
        cursor.addRow(new String[]{selection,sharedPreferences.getString(selection,"")});
